...
$Host.UI.RawUI.WindowTitle = "AI Chat (7086)"          # terprint-ai-chat
$Host.UI.RawUI.WindowTitle = "AI Recommender (7091)"   # terprint-ai-recommender
$Host.UI.RawUI.WindowTitle = "AI Deals (7096)"         # terprint-ai-deals
$Host.UI.RawUI.WindowTitle = "Batch Processor (7076)"  # terprint-batch-processor
$Host.UI.RawUI.RawUI.WindowTitle = "Menu Downloader (7081)" # terprint-menudownloader
...
Each function app has assigned ports to avoid conflicts:

| App | Default Port | Range |
|-----|-------------|-------|
